...
### 1.1 整体架构以及各模块功能
   ...
   ![img](../images/rocketmq/2022-07-02-rocketmq_01.png)
...
2.核心是NamesrvController的启动(里面启动broker的注册的rpc服务, 定时刷新inactive broker..)
启动的main函数:
